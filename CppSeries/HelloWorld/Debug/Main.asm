; Listing generated by Microsoft (R) Optimizing Compiler Version 19.37.32822.0 
	...
	TITLE	C:\Quan Vo Local\Local Dev\CppSeries\HelloWorld\Debug\Main.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_a$ = -8						; size = 4
_main	PROC						; COMDAT
; File C:\Quan Vo Local\Local Dev\CppSeries\HelloWorld\Main.cpp
; Line 5
	push	ebp
	mov	ebp, esp
	...
	mov	eax, -858993460				; ccccccccH
	rep stosd
	mov	ecx, OFFSET __1D1D9E1A_Main@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 6
	mov	DWORD PTR _a$[ebp], 8
; Line 7
	mov	eax, DWORD PTR _a$[ebp]
	add	eax, 1
	mov	DWORD PTR _a$[ebp], eax
; Line 8
	mov	DWORD PTR _string$[ebp], OFFSET ??_C@_05COLMCDPH@Hello@
; Line 10
